  ...
  public static Dictionary<Guid, LgdxRoleData> DefaultRoles { get; set; } = new()
  {
    ...
    },
    {
      ...
      new LgdxRoleData
      {
        ...
        Scopes = [
          "LGDXRobot2Cloud.API/Navigation/Robots/FullAccess"
        ]
      }
    },
    {
      ...
      new LgdxRoleData
      {
        ...
        Scopes = [
          "LGDXRobot2Cloud.API/Navigation/Robots/Read"
        ]
      }
    },
    {
    ...
    },
    {
      ...
      new LgdxRoleData
      {
        ...
        Scopes = [
          "LGDXRobot2Cloud.API/Automation/FullAccess"
        ]
      }
    },
    {
      ...
      new LgdxRoleData
      {
        ...
        Scopes = [
          "LGDXRobot2Cloud.API/Automation/Read"
        ]
      } 
    },
    {
      ...
      new LgdxRoleData
      {
        ...
        Scopes = [
          "LGDXRobot2Cloud.API/Automation/AutoTasks/FullAccess"
        ]
      } 
    },
    {
      ...
      new LgdxRoleData
      {
        ...
        Scopes = [
          "LGDXRobot2Cloud.API/Automation/AutoTasks/Read"
        ]
      } 
    },
    {
      ...
      new LgdxRoleData
      {
        ...
        Scopes = [
          "LGDXRobot2Cloud.API/Automation/AutoTasks/Write",
          "LGDXRobot2Cloud.API/Automation/AutoTasks/Delete"
        ]
      }
    },
    {
