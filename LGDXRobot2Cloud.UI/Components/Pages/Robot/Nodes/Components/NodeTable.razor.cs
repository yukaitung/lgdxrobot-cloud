...
namespace LGDXRobot2Cloud.UI.Components.Pages.Robot.Nodes.Components;

public sealed partial class NodeTable : AbstractTable
{
  [Inject]
  ...
  {
    if (deleteOpt && CurrentPage > 1 && Nodes?.Count == 1)
      CurrentPage--;
